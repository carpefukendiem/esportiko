...
/**
 * Sidebar + mobile nav render immediately; `headerSlot` streams (account block).
 * Main `children` should be wrapped in Suspense in the layout for streaming page data.
 */
export function PortalShell({
  ...
  return (
    <PortalShellCollapsedProvider collapsed={collapsed}>
